...
export const ThemeSwitcher = () => {
  ...
  return (
    <div className="flex h-8 w-14 items-center justify-around rounded-full bg-[#1F2937] transition-all dark:bg-[#111827]">
      <button
      ...
      >
        <svg
          onClick={toogleTheme}
          className="fill-[#1F2937] dark:fill-[#F3F4F6]"
          width="14"
          height="13"
          viewBox="0 0 14 13"
      ...
      >
        <svg
          className="fill-[#F9FAFB] dark:fill-[#111827]"
          width="12"
          height="12"
          viewBox="0 0 12 12"
          xmlns="http://www.w3.org/2000/svg"
